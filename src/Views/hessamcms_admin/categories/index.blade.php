    ...
    @forelse ($categories as $category)
        ...
        <div class="card m-4">
            <div class="card-body">
                ...
                <a href="{{$category->url($locale)}}" class="card-link btn btn-outline-secondary">View Posts in this category</a>
                ...
                <form
                        ...
                        method='post' action='{{route("hessamcms.admin.categories.destroy_category", $category->category_id)}}' class='float-right'>
                    @csrf
                    @method("DELETE")
